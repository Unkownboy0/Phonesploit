...
def open_link():
    print(
        f"\n{color.YELLOW}Enter URL              {color.CYAN}Example :https://github.com/Unkownboy0/Phonesploit.git{color.WHITE}"
    )
    url = input("> ")
...
def visit_me():
    os.system(f"{opener} https://github.com/Unkownboy0/Phonesploit.git")
    print("\n")
